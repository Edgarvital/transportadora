...
public class UserConfiguration : IEntityTypeConfiguration<User>
{
    public void Configure(EntityTypeBuilder<User> builder)
    {
        ...
        builder.Property(x => x.Email).IsRequired(false).HasColumnName("Email").HasMaxLength(200);
        builder.Property(x => x.SenhaHash).IsRequired(false).HasColumnName("SenhaHash").HasMaxLength(255);
